...
function profileSection(locale: Locale): KnowledgeSection {
  ...
  return {
    ...
    body: [
      ...
      `EXPERIENCE: Information Technology Intern at CV. Bima Technologies (June-Sept 2025); Telecommunication Installation Intern at PT Telkom Indonesia (IndiHome, July-Aug 2021); Head of Commission 3 (Student Representative Council / DPA) at HMTT Telkom University (June 2025 - April 2026) and Legislative Staff (Sept 2024 - June 2025); Event Planner at HIPMI PT (2024); Event Planning Staff at Mightyducks Basketball Competition (2024).`,
      ...
      `EDUCATION: Bachelor of Engineering (S.T.) in Telecommunication Engineering from Telkom University, 2022-2026 (Yudisium completed, Nov 2026 commencement, GPA 3.29); Vocational High School at SMK Telkom Bandung, Access Network Engineering (2019-2022).`,
